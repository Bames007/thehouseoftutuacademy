...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Send a written request to info@thehouseoftutuacademy.com with your full name, proof of payment, and reason. Refunds are processed in 7-14 business days and issued back through the original payment method. Please review our complete Refund Policy before enrolling.",
      category: "refunds",
      icon: FileText,
    },
    {
